...
/*   Updated: 2022/03/14 17:51:04 by rmoujan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void left(t_long *game)
{
	...
	{
		game->move++;
		game->img.img = mlx_xpm_file_to_image(game->mlx, "./images/pl.xpm", &game->img.width, &game->img.height);
